  ...
  webServer: [
    ...
    },
    {
      ...
      env: {
        ...
        R2_ACCOUNT_ID: "test",
        R2_PUBLIC_ACCESS_KEY: "test-public-access-key",
        R2_PUBLIC_SECRET_KEY: "test-public-secret-key",
        R2_PRIVATE_ACCESS_KEY: "test-private-access-key",
        R2_PRIVATE_SECRET_KEY: "test-private-secret-key",

...
export async function readThingData(key: string): Promise<ThingDataRecord | null> {
...
export async function writeThingData(
  ...
  try {
    await new Promise<void>((resolve, reject) => {
      ...
      transaction.objectStore(STORE_NAME).put({ key, schemaVersion, updatedAt: Date.now(), value });

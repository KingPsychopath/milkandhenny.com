      ...
      <header className="mb-10">
        ...
        <div className="mt-2 space-y-2">
          ...
          >
            ...
            <a href="#content-summary" className="hover:text-[var(--foreground)] transition-colors">
              content
            </a>
            ...
            <a href="#shared-pages" className="hover:text-[var(--foreground)] transition-colors">
              shared pages
            </a>
            <a
              href="#word-media-orphans"
              className="hover:text-[var(--foreground)] transition-colors"
            >
              media
            </a>
            <a href="#editorial-tools" className="hover:text-[var(--foreground)] transition-colors">
              audit
            </a>
            <a href="#album-manager" className="hover:text-[var(--foreground)] transition-colors">
              albums
            </a>
          </nav>
          <nav
          ...
          >
            ...
            <Link to="/pics" className="hover:text-[var(--foreground)] transition-colors">
              pics
            </Link>
          </nav>
        </div>
        ...
        <div id="album-manager" className="border-t theme-border pt-6 space-y-3 scroll-mt-6">
                ...
                <div className="flex items-center justify-between gap-3">
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    <button
                      type="button"
                      onClick={() =>
                        setExpandedAlbumSlug((curr) => (curr === album.slug ? null : album.slug))
                      }
          ...
          {filteredAlbums.length > 12 ? (
            <button
              ...
              className="font-mono text-xs theme-muted hover:text-[var(--foreground)] transition-colors"
            >
              {showAllAlbums ? "show fewer albums" : `show all albums (${filteredAlbums.length})`}
            </button>
          ) : null}
        </div>
        ...
        <div className="border-t theme-border pt-6">
          ...
          <div className="space-y-2 font-mono text-xs">
            {commandHelpers.map((item) => (
              <div
                key={item.key}
                className="border theme-border rounded-md p-2 flex items-center gap-2"
              >

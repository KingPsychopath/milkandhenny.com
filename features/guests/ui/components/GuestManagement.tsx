    ...
    <div className="space-y-4">
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-xl p-4">
        <p className="text-sm text-amber-800">
          <strong>Note:</strong> Uploading a new CSV will <strong>replace all data</strong>{" "}
          including check-ins.
        </p>
      </div>
    </div>
...
function GamesTab({
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
        <p className="text-sm text-blue-800">
          <strong>Testing tip:</strong> To re-test voting from your own device, clear your
          browser&apos;s localStorage (Developer Tools &gt; Application &gt; Local Storage &gt;
          Clear).
        </p>
      </div>
    </div>
        ...
        <div className="overflow-y-auto max-h-modal-body">
          <div className="p-6 space-y-5">
            <p className="text-xs theme-muted">
              Admin-only actions may prompt for step-up verification and will redirect to{" "}
              <span className="font-mono">/admin</span> if your admin session is missing.
            </p>

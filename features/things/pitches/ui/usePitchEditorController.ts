...
import { usePitchMediaPlayback } from "./PitchMediaPlayback";
import type { PitchImportSummary } from "./PitchImportDialog";
...
export const DEMO_TOUR_STEPS: readonly GuidedTourStep[] = TOUR_STEPS.map((step) => {
  if (step.id === "sound") {
    return {
      ...step,
...
export function hasSeenPitchStudioTour(): boolean {
...
export function rememberPitchStudioTour(): void {
...
export function randomPitchAssetId(): string {
...
export function localMediaAsset(
  file: File,
  kind: "audio" | "video",
  deckId: string,
...
export function friendlyImportError(error: unknown, fileName: string): string {
...
export function readBackupFiles(value: unknown): BinaryFiles {
...
export function zipEntrySize(value: unknown): number | undefined {

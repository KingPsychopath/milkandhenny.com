/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=ops/cloudflare-email-events/wrangler.jsonc ops/cloudflare-email-events/worker-configuration.d.ts` (hash: 2dedc6af4b005d71bf742f3bd646ae9a)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_BASE_URL" | "EMAIL_EVENT_SECRET">> {}
}

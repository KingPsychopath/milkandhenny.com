...
export type ObjectStorageProvider = {
  copyObject: typeof r2.copyObject;
  ...
  isPrivateStorageConfigured: typeof r2.isPrivateStorageConfigured;
  isTransferStorageConfigured: typeof r2.isTransferStorageConfigured;
...
export const r2ObjectStorageProvider: ObjectStorageProvider = {
  copyObject: (...args) => r2.copyObject(...args),
  ...
  isPrivateStorageConfigured: () => r2.isPrivateStorageConfigured(),
  isTransferStorageConfigured: () => r2.isTransferStorageConfigured(),
...
export const copyObject: ObjectStorageProvider["copyObject"] = (...args) =>
  current().copyObject(...args);
...
export const isPrivateStorageConfigured: ObjectStorageProvider["isPrivateStorageConfigured"] = () =>
  current().isPrivateStorageConfigured();
export const isTransferStorageConfigured: ObjectStorageProvider["isTransferStorageConfigured"] =
  () => current().isTransferStorageConfigured();
